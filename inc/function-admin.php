 ...
 */
  function test_add_option(){
    add_settings_field( 'footer_message', 'Footer message du thème ', 'footer_message_theme_display', 'general');
    register_setting( 'general', 'footer_message' );
  }
...
// Bundle functions of custom admin page
  function crevette_custom_settings(){
    ...
    add_settings_field( 'first_name', 'Nom complet', 'crevette_sidebar_name', 'crevette_theme_settings', 'crevette_sidebar_options');
    add_settings_field( 'last_name', 'Nom complet', 'crevette_sidebar_name', 'crevette_theme_settings', 'crevette_sidebar_options');
...
// Sanitization settings
  ...
  function crevette_sidebar_name(){
    ...
    echo '<input type="text" name"'.$first_name.'" placeholder="Prénom" value="'. $first_name .'"> <input type="text" name"'.$last_name.'" placeholder="Nom" value="'. $last_name .'">';
